...
namespace Tutorial
{
    public class PlayerShowRack : MonoBehaviour
    {
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            if (storekeeper != null)
            {
                ...
                if (storekeeper.StorekeeperType == Enumerators.StorekeeperType.ToTake && receptacleObjectType == Enumerators.ReceptacleObjectType.Sword)
                {
                    _tutorialController.TakeMoney();
                    Destroy(this);
                }
            }
        }
